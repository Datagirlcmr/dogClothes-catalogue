...
axios.defaults.headers.common["x-api-key"] = "84c5950a-6f21-41f9-b8b5-6433407fb056";
...
class ProductHandle extends Component {
  ...
  async loadBreedImages() {
    ...
    let breed_images = await this.getDogsImagesByBreed(
      ...
      <div>
        ...
        <div>
          {this.state.images.map((image) => (
            <img className="dog-image" alt="" src={image.url}></img>
          ))}
        </div>
      </div>
    );
